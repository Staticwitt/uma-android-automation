...
const searchConfig: SearchOption[] = [
    ...
    },
    {
        ...
        description: "Scale the stamina stat target by the trainee's running style: Front Runners need less stamina, End Closers more. Off by default.",
        page: "TrainingSettings",
    },
    {
    ...
    },
    {
        ...
        title: "Full Unattended Parent Preset",
        description: "Enables career-complete skill spending and carat-funded race retry (max 2 per career) for hands-off parent runs.",
        page: "ParentFarmingSettings",
    },
    {
        id: "enable-parent-farming-auto-downgrade-forced",
        title: "Auto-Downgrade Infeasible Forced Epithets",
        description: "Moves forced epithets that cannot complete (wrong scenario, missing matchers) into targets when resolving the preset.",
        page: "ParentFarmingSettings",
    },
    {
        id: "enable-parent-farming-adaptive-multi-run",
        title: "Adaptive Multi-Run",
        description: "After a forced epithet miss, downgrades that epithet to target-only and relaxes win-rate/fan floor on the next career.",
        page: "ParentFarmingSettings",
    },
    {
        id: "enable-parent-farming-lock-preset",
        title: "Lock Parent Farming Preset",
    ...
    },
    {
        ...
        title: "General Solver Preset",
        description: "One-tap Smart Race Solver setup without parent farming automation or fan-farming fallback.",
    ...
    {
        id: "trackblazer-mood-recovery-floor",
        title: "Trackblazer Mood Recovery Floor",
        description: "Recover mood only when it drops strictly below this floor. NORMAL (the default) skips recovery at Normal mood so more turns go to training.",
        page: "ScenarioOverridesSettings",
    },
    {
