...
/** Unit tests for [LegacyParentSelector] OCR prefilter helpers (via mirrored patterns). */
class LegacyParentSelectorTest {
    @Test
    fun ocrMightMatchName_acceptsSubstring() {
        assertTrue(ocrMightMatchNameHelper("oguri cap fan", "oguri cap"))
    }
    ...
    /** Mirrors [LegacyParentSelector] private prefilter without widening API surface. */
