 ...
 *
 * Checked within a small region centered on each of the five owned-card slot positions in
 * [CareerSelectionAutomation.OWNED_DECK_SLOT_POSITIONS] to tell an empty slot apart from an already-equipped
 * one, rather than relying on the default (broad) region here.
 */
