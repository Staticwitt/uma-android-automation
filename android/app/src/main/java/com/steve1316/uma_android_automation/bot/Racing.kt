...
class Racing(private val game: Game, private val campaign: Campaign) {
    ...
    /** Minimum energy percentage required to start optional (extra) races. 0 = no gate. Hard requirements bypass this. Also gates the G1-day preference pre-screen and the fan-farming interval fallback. */
    internal val minimumEnergyForOptionalRacing: Int = SettingsHelper.getIntSetting("racing", "minimumEnergyForOptionalRacing", 0)
    ...
    fun checkEligibilityToStartExtraRacingProcess(): Boolean {
        ...
        val hasEnoughEnergy = hasEnoughEnergyForExtraRacing(campaign.trainee.energy, minimumEnergyForOptionalRacing)
        ...
        val fallbackReason =
            when {
                ...
                !hasEnoughEnergy -> "Energy ${campaign.trainee.energy}% is below the extra-racing floor of $minimumEnergyForOptionalRacing%"
